...
var taskInput=document.getElementById("add-task__create");//Add a new task.
...
var createNewTaskElement=function(taskString){
    ...
    editButton.className="tasks__edit-btn btn";

    deleteButton.className="tasks__delete-btn btn";
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    listItem.classList = "completed-tasks__item tasks__item"
